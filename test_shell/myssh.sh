...
function get_server_info(){
    ...
    ;;
    5)  output "Exit Success..."
        exit 0
    ;;
    *)  output "You do not select a number between 1 to 5."
        exit 0
    ;;
    esac
...
function output_info(){
    ...
    output "(2) Test  machine  Server--> 192.168.0.155"
    output "(3) Intranet fort machine--> 192.168.0.215"
    output "(4) Extranet fort machine--> 183.250.89.162"
    output "(5) Exit"
    output "==========================================="
